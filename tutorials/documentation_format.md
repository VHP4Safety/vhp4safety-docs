...
1. Introduction
Provide a short, accessible overview of the tool.
...
Make it easy for users to start using the tool (practical and step based).
...
Structure this section by functionality, so each function is explained clearly and consistently.
For each functionality, include:
3.x Name of the Functionality
...
* Example use case (optional): One sentence illustrating when this function is useful
Repeat this structure for all functionalities.

4. Interpreting the Output
Help users understand what the tool provides and how to act on it.
...
Provide a quick recap and guide next steps.
